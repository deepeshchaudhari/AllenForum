                    ...
                    <div class="tab-content">
                        ...
                        <div class="table-responsive">
                            <table class="table table-stripped">
                                ...
                                $students = $connection->query("SELECT fr.*,fu.user_email AS receptionistMail FROM `forum_receptionist` fr LEFT JOIN forum_users fu on fr.user_id=fu.id ");
                                $sr = 1;
                                while ($student = $students->fetch_object() ){
                                    ...
                                    <tr>
                                        ...
                                        <td style="border:1px solid #FF9800;"><?php echo $student->receptionistMail;?></td>
