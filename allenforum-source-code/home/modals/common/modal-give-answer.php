<div class="modal fade" id="modalGiveAnswer" tabindex="-1" role="dialog" aria-labelledby="modalGiveAnswer">
    <div class="modal-dialog modal-lg" role="document">
        <form id="forumGiveAnswer">
            <div class="modal-content">
                <div class="modal-header bg-primary">
                    <input type="hidden" id="questionsIdToGetQues" name="questionsIdToGetQues" value=""/>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            <span class="control-label text-bold">Question <b style="color: red">*</b></span>
                            <p id="question_label">
                            </p>
                        </div>
                    </div>
...
<!--                    <button type="submit" id="saveAnswerBtn"  onclick="saveMyAnswer(event);" class="btn btn-primary btn-flat pull-left">Save</button>-->
