      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown notifications-menu">
            ...
            <?php
            $usernfo = mysql_query("select * from forum_users where 
              user_email = '".$_SESSION['usersemail']."' AND 
              user_pass = '".$_SESSION['userspassword']."' AND 
              role = '".$_SESSION['userrole']."' ")
            or die("not found the user info".mysql_error());

            // fetch the basic information to display in the header
            while ($userinformation = mysql_fetch_array($usernfo)){
                $userName  =  $userinformation['name'];
                $userRole = $userinformation['role'];
                $profilePic = $userinformation['profile_pic'];
